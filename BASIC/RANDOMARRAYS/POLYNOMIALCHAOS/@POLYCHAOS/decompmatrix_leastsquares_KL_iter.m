function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares_KL_iter(apc,N,fun,n,regul,param,cv,k,tolKL,cvKL,kKL,opts,varargin)
% function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares_KL_iter(apc,N,fun,n,regul,param,cv,k,tolKL,cvKL,kKL,opts,varargin)
...
% 
% function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares_KL_iter(PC,N,fun)
% ordinary least-squares (OLS) minimization (without regularization)
% min_{ u } ||y-A*u||_2^2
% 
% function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares_KL_iter(PC,N,fun,'l0',param)
...
% 
% function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares_KL_iter(PC,N,fun,'l1',param)
