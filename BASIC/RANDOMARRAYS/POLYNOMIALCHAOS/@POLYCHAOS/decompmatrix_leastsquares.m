function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares(apc,N,fun,n,regul,param,cv,k,opts,varargin)
% function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares(PC,N,fun,n,regul,param,cv,k,opts,varargin)
...
% 
% function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares(PC,N,fun)
% ordinary least-squares (OLS) minimization (without regularization)
% min_{ u } ||y-A*u||_2^2
% 
% function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares(PC,N,fun,'l0',param)
...
% 
% function [u,err,x,PC_seq,err_seq,x_seq] = decompmatrix_leastsquares(PC,N,fun,'l1',param)
