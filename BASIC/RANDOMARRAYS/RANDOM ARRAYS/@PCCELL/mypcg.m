...
% option = 'affiche' affichage des informations 

PC=getclassin('PCSTOMODEL',varargin,getclassin('FESTOMODEL',varargin,getPC(K)));      

PC = calc_masse(PC,getPC(K));
P=getP(PC);
n=size(K,1);
