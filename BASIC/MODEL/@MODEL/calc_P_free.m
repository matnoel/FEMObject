function [P,numnode1,numnode2] = calc_P_free(M1,M2,ddls)
% function [P,numnode1,numnode2] = calc_P_free(M1,M2,ddls)
% M1, M2 : MODEL
...
% si v1 est un vecteur de ddl libres defini sur M1
% v2 = P*v1 est le vecteur de ddl libres correspondant defini sur M2
