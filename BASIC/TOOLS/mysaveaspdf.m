function mysaveaspdf(pathname,filename,renderer)
% function mysaveaspdf(pathname,filename,renderer)
% save current figure in PDF format without tons of white space
