function theta = subspaceangle(A,B)
...
%   MATLAB's subspace Rev. 5.10.4.2 fails to provide correct answers
%   for angles close to pi/2 and makes unnecessary data copying 
%   and a for loop that should be vectorized
%
...
%   $Revision: 5.10.4.2 $  $Date: 2004/03/09 16:16:31 $ and below 
...
if issparse(A) | issparse(B)
    A=full(A);
    B=full(B);
%   warning('The code does not work and is not intended for sparse data.')
end
