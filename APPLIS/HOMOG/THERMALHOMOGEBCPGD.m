classdef THERMALHOMOGEBCPGD
    % THERMALHOMOGEBCPGD class
    ...
    methods
        function obj=THERMALHOMOGEBCPGD(size_domain,nb_elem,ls,neg_side,pos_side,delta,varargin)
        ...
        function obj=solve_mode(obj,i,varargin)
            ...
            for j=1:obj.dim
                ...
                u_uf=unfreevector(u_uf,j,obj.model{j});
            end
            obj.u_free{i}=BC_free+u;
            obj.u_unfree{i}=obj.BC{i}+u_uf;
        end
    ...
    methods (Access = private)
        ...
        function obj=definebcs(obj)
            ...
            for i=1:obj.dim
                obj.model{i}=addcl(obj.model{i},POINT([0;obj.size_domain(i)]),'T');
            end
        end
