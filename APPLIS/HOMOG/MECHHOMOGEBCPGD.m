classdef MECHHOMOGEBCPGD
    % MECHHOMOGEBCPGD class
    %   Homogenization of elasticity tensor using ESSENTIAL boundary
    %   conditions
    ...
    methods
        function obj=MECHHOMOGEBCPGD(size_domain,nb_elem,ls,C_ns,C_ps,delta,varargin)
        ...
        function obj=computefields_mode(obj,i,varargin)
            ...
            obj.strainenergydensity{i}=multisvd(expand(sig*obj.strain{i}),...
                'reference',obj.strainenergydensity{i},'maxorder',obj.stress{i}.m*obj.strain{i}.m,varargin{:});
            clear sig;
        end
    ...
    methods (Access = private)
        ...
        function obj=definebcs(obj)
            ...
            for i=1:obj.dim
                obj.model{i}=addcl(obj.model{i},POINT([0;obj.size_domain(i)]),'u');
            end
        end
