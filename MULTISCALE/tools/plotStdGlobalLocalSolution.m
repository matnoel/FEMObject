function plotStdGlobalLocalSolution(glob,patches,interfaces,U,w,varargin)
% function plotStdGlobalLocalSolution(glob,patches,interfaces,U,w,varargin)
% Display the standard deviation of global solution U and local solution w
% glob: Global
% patches: Patches
...
if ischarin('displ',varargin)
    ...
    figure('Name',['Standard deviation of U_' num2str(i) ' and w_' num2str(i) ' over fictitious domain and patches'])
    % set(gcf,'Name',['Standard deviation of U_' num2str(i) ' and w_' num2str(i) ' over fictitious domain and patches'])
else
    figure('Name','Standard deviation of U and w over fictitious domain and patches')
    % set(gcf,'Name','Standard deviation of U and w over fictitious domain and patches')
end
clf
