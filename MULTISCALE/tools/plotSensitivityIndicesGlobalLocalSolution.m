function plotSensitivityIndicesGlobalLocalSolution(glob,patches,interfaces,U,w,alpha,varargin)
% function plotSensitivityIndicesGlobalLocalSolution(glob,patches,interfaces,U,w,alpha,varargin)
% Display the sensitivity indices of global solution U and local solution w
...
if ischarin('displ',varargin)
    ...
    figure('Name',['Sensitivity index of U_' num2str(i) ' and w_' num2str(i) ' over fictitious domain and patches for random variables #' num2str(alpha)])
    % set(gcf,'Name',['Sensitivity index of U_' num2str(i) ' and w_' num2str(i) ' over fictitious domain and patches for random variables #' num2str(alpha)])
else
    figure('Name',['Sensitivity index of U and w over fictitious domain and patches for random variables #' num2str(alpha)])
    % set(gcf,'Name',['Sensitivity index of U and w over fictitious domain and patches for random variables #' num2str(alpha)])
end
clf
