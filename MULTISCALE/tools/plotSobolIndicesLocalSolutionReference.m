function plotSobolIndicesLocalSolutionReference(patches,w_ref,alpha,varargin)
% function plotSobolIndicesLocalSolutionReference(patches,w_ref,alpha,varargin)
% Display the Sobol indices of reference local solution w_ref 
...
if isa(patches,'Patches')
    ...
    for k=1:n
        ...
        plot_sol(patch.S,SensitivityAnalysis.sobolIndices(w_ref{patch.number},alpha,d)',varargin{:});
