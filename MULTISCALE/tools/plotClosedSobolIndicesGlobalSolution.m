function plotClosedSobolIndicesGlobalSolution(glob,U,alpha,varargin)
% function plotClosedSobolIndicesGlobalSolution(glob,U,alpha,varargin)
% Display the Closed Sobol indices of global solution U associated with the
...
d = ndims(U);
sU = SensitivityAnalysis.closedSobolIndices(U,alpha,d)';
