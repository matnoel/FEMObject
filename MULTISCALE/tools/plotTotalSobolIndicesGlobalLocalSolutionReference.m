function plotTotalSobolIndicesGlobalLocalSolutionReference(glob,patches,interfaces,U_ref,w_ref,alpha,varargin)
% function plotTotalSobolIndicesGlobalLocalSolutionReference(glob,patches,interfaces,U_ref,w_ref,alpha,varargin)
% Display the Total Sobol indices of reference global solution U_ref and local solution w_ref
