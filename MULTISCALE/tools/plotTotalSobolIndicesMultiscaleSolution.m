function plotTotalSobolIndicesMultiscaleSolution(glob,patches,interfaces,U,w,alpha,varargin)
% function plotTotalSobolIndicesMultiscaleSolution(glob,patches,interfaces,U,w,alpha,varargin)
% Display the Total Sobol indices of multiscale solution u=(U,w) associated with the
