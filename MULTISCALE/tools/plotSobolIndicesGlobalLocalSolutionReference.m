function plotSobolIndicesGlobalLocalSolutionReference(glob,patches,interfaces,U_ref,w_ref,alpha,varargin)
% function plotSobolIndicesGlobalLocalSolutionReference(glob,patches,interfaces,U_ref,w_ref,alpha,varargin)
% Display the Sobol indices of reference global solution U_ref and local solution w_ref
