function plotStdMultiscaleSolutionReference(glob,patches,interfaces,U_ref,w_ref,varargin)
% function plotStdMultiscaleSolutionReference(glob,patches,interfaces,U_ref,w_ref,varargin)
% Display the standard deviation of reference multiscale solution u_ref=(U_ref,u_ref)
