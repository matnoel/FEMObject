function plotMeanGlobalLocalSolutionReference(glob,patches,interfaces,U_ref,w_ref,varargin)
% function plotMeanGlobalLocalSolutionReference(glob,patches,interfaces,U_ref,w_ref,varargin)
% Display the mean (mathematical expectation) of reference global solution U_ref and local solution w_ref
