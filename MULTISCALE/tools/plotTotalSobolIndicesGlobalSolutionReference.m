function plotTotalSobolIndicesGlobalSolutionReference(glob,U_ref,alpha,varargin)
% function plotTotalSobolIndicesGlobalSolutionReference(glob,U_ref,alpha,varargin)
% Display the Total Sobol indices of reference global solution U_ref associated 
...
d = ndims(U_ref);
sU_ref = SensitivityAnalysis.totalSobolIndices(U_ref,alpha,d)';
