function plotVarianceGlobalLocalSolutionReference(glob,patches,interfaces,U_ref,w_ref,varargin)
% function plotVarianceGlobalLocalSolutionReference(glob,patches,interfaces,U_ref,w_ref,varargin)
% Display the variance of reference global solution U_ref and local solution w_ref
