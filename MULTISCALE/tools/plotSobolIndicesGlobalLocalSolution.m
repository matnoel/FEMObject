function plotSobolIndicesGlobalLocalSolution(glob,patches,interfaces,U,w,alpha,varargin)
% function plotSobolIndicesGlobalLocalSolution(glob,patches,interfaces,U,w,alpha,varargin)
% Display the Sobol indices of global solution U and local solution w
...
if ischarin('displ',varargin)
    ...
    figure('Name',['Sobol index of U_' num2str(i) ' and w_' num2str(i) ' over fictitious domain and patches for random variables #' num2str(alpha)])
    % set(gcf,'Name',['Sobol index of U_' num2str(i) ' and w_' num2str(i) ' over fictitious domain and patches for random variables #' num2str(alpha)])
else
    figure('Name',['Sobol index of U and w over fictitious domain and patches for random variables #' num2str(alpha)])
    % set(gcf,'Name',['Sobol index of U and w over fictitious domain and patches for random variables #' num2str(alpha)])
end
clf
