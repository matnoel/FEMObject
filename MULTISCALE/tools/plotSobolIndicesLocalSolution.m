function plotSobolIndicesLocalSolution(patches,w,alpha,varargin)
% function plotSobolIndicesLocalSolution(patches,w,alpha,varargin)
% Display the Sobol indices of local solution w associated with the
...
if isa(patches,'Patches')
    ...
    for k=1:n
        ...
        plot_sol(patch.S,SensitivityAnalysis.sobolIndices(w{patch.number},alpha,d)',varargin{:});
